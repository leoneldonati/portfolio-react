      ...
      <div className="Container">
        <nav className="Container-nav--1">
          <ul className="Container-ul--1">
            ...
            <li>
              <a
                href="https://docs.google.com/document/d/1vlqrpa-HR_t80kib254x0BMQpKXzzkQFuLrfsHyam5o/edit?usp=share_link"
                className="Container-a--1"
                title="Curriculum"
                rel="noreferrer noopener"
                target="_blank"
